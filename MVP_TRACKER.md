# MVP Tracker — Clube da Régua

## Issues do MVP

- [x] ISSUE-001 — Autenticação Cliente
- [x] ISSUE-002 — Fluxo Real de Agendamento
- [x] ISSUE-003 — Central de Solicitações
...
Atualizar este tracker ao finalizar cada issue, mantendo a ordem oficial do MVP.
