...
- Menus devem usar ícones consistentes entre Cliente e Gestão.
- Botões de ferramenta devem usar ícones familiares.
- Ícones devem ajudar a leitura, não decorar em excesso.
