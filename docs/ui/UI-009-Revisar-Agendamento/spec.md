...
6. aviso sobre validação automática da disponibilidade;
...
- impedir envios duplicados enquanto o agendamento estiver em andamento;
- login e cadastro retornam para esta tela;
- falha não apaga os dados preenchidos;
- sucesso abre a tela de agendamento confirmado.

## Linguagem

- usar `agendamento` e confirmar somente após o retorno positivo da gravação;
